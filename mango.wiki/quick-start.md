...
- [Configure Monitors](monitors) — Set up resolution, scaling, and multi-monitor layouts.
- [Window Rules](rules#window-rules) — Define how specific applications should behave.
- [Appearance](theming) — Customize colors, borders, gaps, and effects.
