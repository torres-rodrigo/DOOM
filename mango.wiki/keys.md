...
| `focusmon` | `left/right/up/down/monitor_spec` | Focus monitor by direction or [monitor spec](monitors#monitor-spec-format). |
| `tagmon` | `left/right/up/down/monitor_spec,[keeptag]` | Move window to monitor by direction or [monitor spec](monitors#monitor-spec-format). `keeptag` is 0 or 1. |
...
| `disable_monitor` | `monitor_spec` | Shutdown monitor. Accepts a [monitor spec](monitors#monitor-spec-format). |
| `enable_monitor` | `monitor_spec` | Power on monitor. Accepts a [monitor spec](monitors#monitor-spec-format). |
| `toggle_monitor` | `monitor_spec` | Toggle monitor power. Accepts a [monitor spec](monitors#monitor-spec-format). |
