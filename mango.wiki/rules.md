...
| `monitor` | string | Any | Assign to monitor by [monitor spec](monitors#monitor-spec-format) (name, make, model, or serial) |
...
> **Tip:** For detailed visual effects configuration, see the [Window Effects](effects) page for blur, shadows, and opacity settings.
...
> **Tip:** For comprehensive layout configuration, see the [Layouts](layouts) page for all layout options and detailed settings.
...
> **Tip:** For detailed animation configuration, see the [Animations](animations) page for available types and settings.
...
> **Tip:** For scratchpad usage, see the [Scratchpad](scratchpad) page for detailed configuration examples.

### Performance & Tearing

| Parameter | Type | Values | Description |
| :--- | :--- | :--- | :--- |
| `force_tearing` | integer | `0` / `1` | Set window to tearing state, refer to [Tearing](monitors#tearing-game-mode) |
...
> **Tip:** See [Layouts](layouts#supported-layouts) for detailed descriptions of each layout type.
...
> **Tip:** For Waybar configuration with persistent tags, see [Status Bar](status-bar) documentation.
...
> **Tip:** For animation types, see [Animations](animations#animation-types). For visual effects, see [Window Effects](effects).
